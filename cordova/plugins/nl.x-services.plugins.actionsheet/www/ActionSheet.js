...
cordova.addConstructor(ActionSheet.install);window.plugins = window.plugins || {};
window.plugins.actionsheet = window.plugins.actionsheet || {};

require('cordova/builder').assignOrWrapInDeprecateGetter(window.plugins, 'actionsheet', module.exports);window.plugins = window.plugins || {};
window.plugins.actionsheet = window.plugins.actionsheet || {};
...
require('cordova/builder').assignOrWrapInDeprecateGetter(window.plugins, 'actionsheet', module.exports);