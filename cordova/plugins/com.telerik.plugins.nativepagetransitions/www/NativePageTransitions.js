...
cordova.addConstructor(NativePageTransitions.install);window.plugins = window.plugins || {};
window.plugins.nativepagetransitions = window.plugins.nativepagetransitions || {};

require('cordova/builder').assignOrWrapInDeprecateGetter(window.plugins, 'nativepagetransitions', module.exports);window.plugins = window.plugins || {};
window.plugins.nativepagetransitions = window.plugins.nativepagetransitions || {};
...
require('cordova/builder').assignOrWrapInDeprecateGetter(window.plugins, 'nativepagetransitions', module.exports);